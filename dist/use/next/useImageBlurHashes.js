...
export default function useImageBlurHashes(imgUrlList, args) {
    ...
    useEffect(function () {
        var genImageBlurHashes = function () { return __awaiter(_this, void 0, void 0, function () {
            var resources;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(imgUrlList.map(function (imgUrl) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, genImageBlurHash(imgUrl, w, q)];
